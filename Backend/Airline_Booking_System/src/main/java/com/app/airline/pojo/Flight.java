...
@Entity
@Table(name = "flight")
@SequenceGenerator(name = "flight_seq", sequenceName = "flight_seq", initialValue = 9001)
public class Flight {
	@Id
	...
	public Flight(int flightNumber, String source, String destination, LocalDate travelDate, LocalTime arrivalTime,
			LocalTime departureTime, double price, int availableSeats) {
		super();

...
import com.app.airline.ListPassenger;
...
import com.app.airline.service.BookingService;
import com.app.airline.service.FlightService;
...
public class BookingController {
	...
	public String addBooking(@RequestBody Booking booking, @RequestParam int fid, String source, String destination,
		...
		System.out.println("in booking done!!!");
//		Flight flight = flightservice.fetchFlight(source, destination, LocalDate.parse(date));
	...
	public String addPassengers(@RequestBody ListPassenger pass1, @PathVariable int bid) {
		System.out.println("in passenger added!!!");
//		int pid = bookservice.addPassenger(passenger, bid);
		...
		return "Passenger added with id's " + s1;
	}

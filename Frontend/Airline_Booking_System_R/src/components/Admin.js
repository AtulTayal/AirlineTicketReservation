...
import plane from '../assets/images/plane5.jpg';
            ...
            <div className="card m-auto" style={{width: "23rem"}}>
                ...
                <ul className="list-group list-group-flush">
                    <li className="list-group-item">
                        <Link className="card-link" to="/addFlight">Add Flight</Link>
                    </li>
                    <li className="list-group-item">
                        <Link className="card-link" to="/allFlights">All Flights</Link>
                    </li>

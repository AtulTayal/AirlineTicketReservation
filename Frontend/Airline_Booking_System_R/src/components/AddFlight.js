...
import plane from '../assets/images/addflight.png';
        ...
        <div className="container-fluid" style={styling.wrapper}>
            ...
            <form className="m-auto mt-3 m-1 border border-dark p-3" onSubmit={this.onSave}
             style={styling.formStyle}>
                ...
                <div className="input-group mb-2 mr-sm-2">
                    ...
                    <select className="custom-select my-1 mr-sm-2" id="source" name="source" onClick={this.handleInput} required>
                       <option value="Delhi" onClick={this.handleInput}>Delhi</option>
                        ...
                        <option value="Chandigarh" onClick={this.handleInput}>Chandigarh</option>
                        <option value="Lucknow" onClick={this.handleInput}>Lucknow</option>
                        <option value="Kanpur" onClick={this.handleInput}>Kanpur</option>
                ...
                <button type="reset" className="btn btn-warning mr-4">Reset</button>
            </form>
            </div>
            <Footer/>
        </div>

...
export default class Login extends Component{
    ...
    return (
        <div class='pt-5'>
            <Header />
                <div class="py-5" style={{backgroundImage: `url(${loginbg})`,overflow: 'hidden', height: '600px'}}>
				<div class="row mb-4">
					<div class="col-lg-8 mx-auto text-center">
					<h1 class="display-6" style={{color:'black', fontWeight:'50pt'}}>Login</h1>
					</div>
				...
				<div class="col-md-6 mx-auto">
                    ...
                    <div class="bg-orange shadow-sm pt-4 pl-2 pr-2 pb-2">

...
import planeBG from "../assets/images/reg.jpg";
...
export default class Register extends Component {
	...
	*/
	registerUser = () =>{
        ...
        //   } else if (this.state.email !== regemail) {
    ...
    return (
        <div class='pt-5'>
            <Header />
			<div class="py-5" style={{backgroundImage: `url(${planeBG})`,overflow: 'hidden',width: '1300px' ,height: '1200px'}}>
				<div className="row mb-4">
					<div className="col-lg-8 mx-auto text-center">
					<h1 className="display-6" style={{color:'black', fontWeight:'50pt'}}>Registration</h1>
					</div>
				</div> 
				<div className="row">
				<div className="col-md-6 mx-auto">
                    ...
                    <div className="bg-orange shadow-sm pt-4 pl-2 pr-2 pb-2">
                            ...
                            <form>
                                ...
                                <div className="form-group"> 
									<h6><span className="form-label">Confirm Password</span></h6>
										<input type="text" name="cpasswd" placeholder="confirm password" onChange={this.handlePass} className="form-control" required/><div className="text-danger">{this.state.cp} </div> 
								</div>

    ...
    */
    ...
    render() {
        ...
        this.psg_gender = this.passengers.map(psg => {
            ...
            this.psg_pid = this.passengers.map(psg => {
                return(
                    <span>{psg.pid}<br/></span> 
                    )    
                })
    ...
    return (
       ...
       <div class='pt-3'>
        <Header />
        <div class="py-6" style={{backgroundImage: `url(${planeBG})`,overflow: 'hidden', height: '700px'}}>
